...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="duckdb-deltatable-extension" -DDUCKDB_OOT_EXTENSION_DUCKDB-DELTATABLE-EXTENSION_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_DUCKDB-DELTATABLE-EXTENSION_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_DUCKDB-DELTATABLE-EXTENSION_INCLUDE_PATH="$(PROJ_DIR)src/include"
...
test_debug: debug test/simple_table
